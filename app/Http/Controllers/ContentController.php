...
class ContentController extends Controller
{
    ...
    public function getList(){
        try{
            ...
            $data = content::select(
                'contents.*',
                'contents.updated_at as updated_date',
                'admins.name as user_edit_name'
            )
            ->join('admins','admins.id','contents.user_edit')
            ->where([
        ...
        try{
            DB::beginTransaction();
                ...
                if ($request->hasFile('pic')) {
                    ...
                    $path = 'upload/images/content/' . $picture;

                    $directory = public_path('upload/images/content');
    ...
    public function update(Request $request){
        try{
            DB::beginTransaction();
                ...
                $data['user_edit'] = auth()->user()->id;
                $create = content::where('id',$request->id)->update($data);
    ...
    public function updateStatus($id){
        try{
            ...
            $update = content::where('id',$id)->update(['status'=>request()->status,'user_edit'=>auth()->user()->id]);
    ...
    public function delete($id){
        try{
            DB::beginTransaction();
            $update = content::where('id',$id)->update(['is_delete'=> 1,'user_edit'=>auth()->user()->id ]);
            DB::commit();
            return response()->json([
                'success' => true,
