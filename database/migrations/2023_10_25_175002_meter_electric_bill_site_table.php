...
class MeterElectricBillSiteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('meter_electric_bill_sites', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('meter_electric_bill_sites');
    }
}
