        ...
        <div class="container">
            <div class="d-flex justify-space-between align-items-center mt-4 mb-4">
                <v-card-text class="p-0">
                    <h1 class="font-20 m-0">จัดการใบวางบิลและใบเสร็จอื่น ๆ</h1>
                </v-card-text>
            ...
            <v-card elevation="2">
                <v-card-title class="justify-space-between text-card-title">
                    รายการใบวางบิลและใบเสร็จอื่น ๆ
                </v-card-title>
                <v-row class="p-4">
                    <v-col cols="6">
                        <v-btn @click="linkPage('/managebill')" color="success" class="no-border" width="100%"
                            outlined> ใบวางบิล </v-btn>
                    </v-col>
                    <v-col cols="6">
                        <v-btn @click="linkPage('/managebillotherreceipts')" color=""
                            class="no-border no-border-all color-black" width="100%" outlined> ใบเสร็จอื่น ๆ </v-btn>
                    </v-col>
                </v-row>
...
export default {
    data() {
        return {
            ...
            submenu: [
                {
                    text: 'จัดการใบวางบิลและใบเสร็จอื่น ๆ',
                    disabled: true,
                },
            ],
            search: "",
