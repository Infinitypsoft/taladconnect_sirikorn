              ...
              <v-col xs="12" sm="12" md="12" lg="12" xl="12">
                ...
                <v-card-text class="p-0 mt-4">
                  <div class="d-flex align-center mb-4">
                    ...
                    />
                    <span class="font-16 color-title-card"
                      >การบันทึกค่ามิเตอร์น้ำของแต่ละอาคาร</span
                    >
                  </div>
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         v-if="member_data.length == 0"
                            @click="
                              linkPage(
                                '/managemeterwater/billcycle/insertmeterwaterbill?id=' +
                          ...
                          <v-btn v-else @click="linkPage('/managemeterwater/billcycle/insertmeterwaterbilldetail?id='+item.id+'&bill_id='+$route.query.id)" class="ma-1 m-0 p-0" width="38" height="38" outlined large fab
                          ...
                          <tr>
                            ...
                            <td>
                              <v-btn
                                @click="
                                  linkPage(
                                    '/managemeterwater/billcycle/renterdetailbill?id='+item.id
                                  )
                                "
                                class="ma-1 m-0 p-0"
                                width="38"
        ...
        <v-card>
          <v-card-text class="d-flex flex-column align-center pb-0">
            ...
            <h3 class="mag-modal mb-8">
              ท่านยืนยันการชำระเงินเลขที่บิล IVW-23120001 ของผู้เช่าใช่หรือไม่ ?
              ?
            </h3>
          </v-card-text>
