    ...
    <div class="container">
      <div class="d-flex justify-space-between align-items-center mt-4 mb-4">
        <v-card-text class="p-0">
          <h1 class="font-20 m-0">รอบบิลค่าน้ำ</h1>
        </v-card-text>
      ...
      <v-card elevation="2">
        ...
        <v-card-subtitle class="mb-6">
          <v-btn
            @click="linkPage('/managemeterwater/billcycle/add')"
                  ...
                  <tbody>
                    <tr v-for="(item, index) in meter_data" :key="item">
                      ...
                      <td>
                        ...
                        <v-btn
                        @click="linkPage('/managemeterwater/billcycle/detailbill?id='+item.id)"
                          class="ma-1 m-0 p-0"
                          width="38"
                          height="38"
                          outlined
