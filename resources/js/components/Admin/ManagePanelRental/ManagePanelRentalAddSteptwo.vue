...
export default {
    ...
    async mounted() {
        ...
        if (managepanelrental_add) {
            ...
            this.net_price_guarantee_service_rate = data.guarantee_service_rate
            this.net_price_guarantee_water_rate = data.guarantee_water_rate
            this.net_price_guarantee_electricity_rate = data.guarantee_electricity_rate
            this.net_price_guarantee_hood_rate = data.guarantee_hood_rate
            this.net_price_cost_rental_rate = data.cost_rental_rate
            this.net_price_cost_common_rate = data.cost_common_rate
            this.net_price_annual_fee = data.annual_fee
