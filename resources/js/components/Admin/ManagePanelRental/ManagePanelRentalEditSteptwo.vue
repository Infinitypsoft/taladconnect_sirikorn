                                ...
                                <v-card-title class="p-0 pb-5 justify-space-between text-card-title">
                                    <v-row>
                                        ...
                                        <v-col cols="6" class=" d-flex align-start justify-end">
                                            <v-btn @click="linkPage(`/managepanelrental/edit?id=${$route.query.id}`)" outlined
                                                class="btn pr-30 font-16 rounded-xl " color="success">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px; text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        v-on:keyup="() => {
                                                                            net_price_annual_fee = (annual_fee - discount_annual_fee)
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        single-line v-on:keyup="() => {
                                                                            net_price_guarantee_service_rate = (guarantee_service_rate - discount_guarantee_service_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px;text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        single-line v-on:keyup="() => {
                                                                            net_price_guarantee_water_rate = (guarantee_water_rate - discount_guarantee_water_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px;text-align: center;">
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        dense single-line v-on:keyup="() => {
                                                                            net_price_guarantee_electricity_rate = (guarantee_electricity_rate - discount_guarantee_electricity_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px;text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        single-line v-on:keyup="() => {
                                                                            net_price_guarantee_hood_rate = (guarantee_hood_rate - discount_guarantee_hood_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px;text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px; text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        single-line v-on:keyup="() => {
                                                                            net_price_cost_rental_rate = (cost_rental_rate - discount_cost_rental_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px; text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px; text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        single-line v-on:keyup="() => {
                                                                            net_price_cost_common_rate = (cost_common_rate - discount_cost_common_rate)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px; text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px; text-align: center;">
                                                                    <v-text-field hide-details="auto"
                                                                        ...
                                                                        v-on:keyup="() => {
                                                                            other_net_price = (other_price - other_price_discount)
                                                                            cal_total_price_before_tax();
                                                                        }" required></v-text-field>
                                                                </td>
                                                                <td style="width: 250px; text-align: center;">
                                            ...
                                            <v-col cols="12" lg="7" md="9" sm="10">
                                                <v-card elevation="0" class="rounded-lg p-4 pt-6 pb-6 bg-border-green">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="4" class="text-center">
                                                            <p class="font-16">{{ formatPrice(total_price_before_tax) }}</p>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
                                                        <v-col cols="3">
...
export default {
    ...
    async mounted() {
        ...
        let managepanelrental_edit = window.localStorage.getItem("managepanelrental_edit");
        this.select_block_list = window.localStorage.getItem("managepanelrental_edit_select_block_list");
        if (managepanelrental_edit) {
            const data = JSON.parse(managepanelrental_edit)
            ...
            this.net_price_guarantee_service_rate = (parseFloat(data.guarantee_service_rate) - this.discount_guarantee_service_rate)
            this.net_price_guarantee_water_rate = (parseFloat(data.guarantee_water_rate) - this.discount_guarantee_water_rate)
            this.net_price_guarantee_electricity_rate = (parseFloat(data.guarantee_electricity_rate) - this.discount_guarantee_electricity_rate)
            this.net_price_guarantee_hood_rate = (parseFloat(data.guarantee_hood_rate) - this.discount_guarantee_hood_rate)
            this.net_price_cost_rental_rate = (parseFloat(data.cost_rental_rate) - this.discount_cost_rental_rate)
            this.net_price_cost_common_rate = (parseFloat(data.cost_common_rate) - this.discount_cost_common_rate)
            this.net_price_annual_fee = (parseFloat(data.annual_fee) - this.discount_annual_fee)
