        ...
        <div class="container">
            <div class="d-flex justify-space-between align-items-center mt-4 mb-4">
                <v-card-text class="p-0">
                    <h1 class="font-20 m-0">สร้างการเช่าแผงใหม่</h1>
                </v-card-text>
                                ...
                                <v-card-title class="p-0 pb-5 justify-space-between text-card-title">
                                    <v-row>
                                        ...
                                        <v-col cols="6" class=" d-flex align-start justify-end">
                                            <v-btn @click="linkPage(`/managepanelrental/add?id=${$route.query.id}`)"
                                                    ...
                                                    <template v-slot:default>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    {{ net_price_guarantee_service_rate }}
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    {{ net_price_guarantee_water_rate }}
                                                                </td>
                                                            </tr>
                                                            <!-- ประกันมิเตอร์ไฟ -->
                                                            <tr>
                                                                ...
                                                                <td style="width: 250px;text-align: center;">
                                                                    {{ net_price_guarantee_electricity_rate }}
                                                                </td>
                                                            </tr>
                                                            <!-- ประกันเครื่องดูดควัน -->
                                                            <tr>
                                                ...
                                                <v-card elevation="0" class="rounded-lg p-4 pt-6 pb-6 bg-border-green">
                                                    <v-row>
                                                        ...
                                                        <v-col cols="4" class="text-center ">
                                                            <p class="font-16  mb-0">{{ total_price_before_tax }}</p>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
                                                        <v-col cols="3">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="4" class="text-center">
                                                            <p class="font-16">{{ total_price_after_tax }}</p>
                                                        </v-col>
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="4"
                                                            ...
                                                            <p class="mb-0 font-16">{{ net_withholding_tax }}</p>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
                                                        <v-col cols="3">
                                                        ...
                                                        <v-col cols="4" class="text-center">
                                                            <p class="font-16">{{ total_withholding_tax }}</p>
                                                        </v-col>
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="4"
                                                            class="text-center d-flex align-center justify-center">
                                                            <p class="mb-0 font-16">{{ total_price_insurance }}</p>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
                                                        <v-col cols="12">
...
export default {
    ...
    async mounted() {
        ...
        this.select_block_list = window.localStorage.getItem("managepanelrental_add_select_block_list");
        if (managepanelrental_add) {
            ...
            this.tax_select_type = data.vat_type
            // this.stall_select_type = data.stall_select_type
            // this.stall_lists[0].name = data.stall_lists_name



            this.annual_fee = data.annual_fee.toFixed(2)
            this.guarantee_service_rate = data.guarantee_service_rate.toFixed(2)
            this.guarantee_water_rate = data.guarantee_water_rate.toFixed(2)
            this.guarantee_electricity_rate = data.guarantee_electricity_rate.toFixed(2)
            this.guarantee_hood_rate = data.guarantee_hood_rate.toFixed(2)
            this.cost_rental_rate = data.cost_rental_rate.toFixed(2)
            this.cost_common_rate = data.cost_common_rate.toFixed(2)

            this.net_price_guarantee_service_rate = data.guarantee_service_rate.toFixed(2)
            this.net_price_guarantee_water_rate = data.guarantee_water_rate.toFixed(2)
            this.net_price_guarantee_electricity_rate = data.guarantee_electricity_rate.toFixed(2)
            this.net_price_guarantee_hood_rate = data.guarantee_hood_rate.toFixed(2)
            this.net_price_cost_rental_rate = data.cost_rental_rate.toFixed(2)
            this.net_price_cost_common_rate = data.cost_common_rate.toFixed(2)
            this.net_price_annual_fee = data.annual_fee.toFixed(2)
