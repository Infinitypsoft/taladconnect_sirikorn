              ...
              <v-card class="mt-2 p-5 pt-3 hfc" elevation="2">
                <v-form ref="input_form" @submit.prevent="update()">
                  <v-list-item three-line class="pl-0 pr-0 ml-0 mr-0">
                    <v-row>
                        ...
                        <v-card-text class="p-0 mt-2">
                          ...
                          <div>
                            ...
                            <v-file-input
                              ...
                              @change="onFileChange(data_th.pic, 0)"
                              single-line
                              clearable
                              clear-icon=""
                      ...
                      <v-col xs="12" sm="12" md="12" lg="12" xl="12">
                        <v-row>
                          <v-col
                            v-for="(item, i) in data_th.pic_list"
                            :key="i"
                            cols="12"
                            xs="12"
                            sm="12"
                          ...
                          >
                            ...
                            <div>
                              <v-file-input
                                ...
                                v-model="item.pic"
                                :rules="[(v) => !!v || 'กรุณาเลือกรูปภาพ']"
                                @change="onFileChangeArr(item.pic, i)"
                                single-line
                                clearable
                                clear-icon=""
                                label="กรุณาเลือกไฟล์รูปภาพ"
                  ...
                  <v-card-text class="p-0 mt-8">
                    ...
                    <div>
                      <v-text-field
                        ...
                        v-model="data_th.description_short"
                        outlined
                        dense
                        single-line
                      ...
                      <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                        ...
                        <div>
                          <v-text-field
                            ...
                            v-model="data_th.instagram_link"
                            outlined
                            dense
                            single-line
                          ...
                          <v-card-text class="p-0 mt-6">
                            ...
                            <div>
                              ...
                              <v-file-input
                                ...
                                id="uploader"
                                accept="image/*"
                                v-model="data_th.product_1_pic"
                                :rules="[(v) => !!v || 'กรุณาเลือกรูปภาพ']"
                                @change="onFileChange(data_th.product_1_pic, 1)"
                                single-line
                                clearable
                                clear-icon=""
                                label="กรุณาเลือกไฟล์รูปภาพ"
                        ...
                        <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                          ...
                          <div>
                            <v-text-field
                              ...
                              v-model="data_th.product_1_name"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-text-field
                              ...
                              v-model="data_th.product_1_price"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-textarea
                              ...
                              v-model="data_th.product_1_description"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <v-card-text class="p-0 mt-6">
                            ...
                            <div>
                              ...
                              <v-file-input
                                ...
                                id="uploader"
                                accept="image/*"
                                v-model="data_th.product_2_pic"
                                :rules="[(v) => !!v || 'กรุณาเลือกรูปภาพ']"
                                @change="onFileChange(data_th.product_2_pic, 2)"
                                single-line
                                clearable
                                clear-icon=""
                                label="กรุณาเลือกไฟล์รูปภาพ"
                        ...
                        <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                          ...
                          <div>
                            <v-text-field
                              ...
                              v-model="data_th.product_2_name"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-text-field
                              hide-details="auto"
                              label="กรุณากรอกราคาอาหาร"
                              v-model="data_th.product_2_price"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-textarea
                              label="กรุณากรอกคำอธิบายเมนูโดยย่อ"
                              v-model="data_th.product_2_description"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <v-card-text class="p-0 mt-6">
                            ...
                            <div>
                              ...
                              <v-file-input
                                ...
                                id="uploader"
                                accept="image/*"
                                v-model="data_th.product_3_pic"
                                :rules="[(v) => !!v || 'กรุณาเลือกรูปภาพ']"
                                @change="onFileChange(data_th.product_3_pic, 3)"
                                single-line
                                clearable
                                clear-icon=""
                                label="กรุณาเลือกไฟล์รูปภาพ"
                        ...
                        <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                          ...
                          <div>
                            <v-text-field
                              ...
                              v-model="data_th.product_3_name"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-text-field
                              hide-details="auto"
                              label="กรุณากรอกราคาอาหาร"
                              v-model="data_th.product_3_price"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-textarea
                              label="กรุณากรอกคำอธิบายเมนูโดยย่อ"
                              v-model="data_th.product_3_description"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <v-card-text class="p-0 mt-6">
                            ...
                            <div>
                              ...
                              <v-file-input
                                ...
                                id="uploader"
                                accept="image/*"
                                v-model="data_th.product_4_pic"
                                :rules="[(v) => !!v || 'กรุณาเลือกรูปภาพ']"
                                @change="onFileChange(data_th.product_4_pic, 4)"
                                single-line
                                clearable
                                clear-icon=""
                                label="กรุณาเลือกไฟล์รูปภาพ"
                        ...
                        <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                          ...
                          <div>
                            <v-text-field
                              ...
                              v-model="data_th.product_4_name"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-text-field
                              hide-details="auto"
                              label="กรุณากรอกราคาอาหาร"
                              v-model="data_th.product_4_price"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                          ...
                          <div>
                            <v-textarea
                              label="กรุณากรอกคำอธิบายเมนูโดยย่อ"
                              v-model="data_th.product_4_description"
                              outlined
                              dense
                              single-line
                              :rules="rules.tiktok_link"
                  ...
                  <v-card-text class="p-0">
                    ...
                    <div>
                      <vue-editor v-model="data_th.description"></vue-editor>
                    </div>
                  </v-card-text>
                  <v-card-actions>
  ...
  methods: {
    ...
    async getStoreById() {
      ...
      await store_api.getStoreById(id, config).then((result) => {
        if (result.data.success === true) {
          this.data_th = result.data.data;
          this.data_th.pic = { name: this.data_th.pic };
          this.imagePreviewURL[0] = this.base_url + "/" + this.data_th.pic_path;
          this.imagePreviewURL[1] =
            this.base_url + "/" + this.data_th.product_1_pic_path;
          this.imagePreviewURL[2] =
            this.base_url + "/" + this.data_th.product_2_pic_path;
          this.imagePreviewURL[3] =
            this.base_url + "/" + this.data_th.product_3_pic_path;
          this.imagePreviewURL[4] =
            this.base_url + "/" + this.data_th.product_4_pic_path;
          this.data_th.product_1_pic = { name: this.data_th.product_1_pic };
          this.data_th.product_2_pic = { name: this.data_th.product_2_pic };
          this.data_th.product_3_pic = { name: this.data_th.product_3_pic };
          this.data_th.product_4_pic = { name: this.data_th.product_4_pic };
          this.data_th.pic_list = this.data_th.pic_list.map((o, i) => {
            this.imagePreviewURLArr.push(this.base_url + "/" + o.pic_path);
            return { ...o, pic: { name: o.pic } };
          });
          this.block_list = this.data_th.block_list;
          this.data_th.block_list = this.data_th.block_list.map((o) => {
    ...
    async update() {
      ...
      await this.pic_list.forEach((item) => {
        this.data.append(item.id, item.file);
      });
      this.data.append("id", this.$route.query.store_id);
      this.data.append("pic", this.data_th.pic);
      this.data.append(
        "pic_list",
        JSON.stringify(
          await this.data_th.pic_list.map((o) => {
            return o.is_delete ? {id: o.id, is_delete: o.is_delete} : { id: o.id };
          })
        )
      );
      this.data.append("store_name", this.data_th.store_name);
      this.data.append("store_type", this.data_th.store_type);
      this.data.append("product_type", [this.data_th.product_type]);
      this.data.append("description_short", this.data_th.description_short);
      this.data.append("description", this.data_th.description);
      this.data.append("price_min", this.data_th.price_min);
      this.data.append("price_max", this.data_th.price_max);
      this.data.append("time_open", this.data_th.time_open);
      this.data.append("time_close", this.data_th.time_close);
      this.data.append("tel", this.data_th.tel);
      this.data.append("location", this.data_th.location);
      this.data.append("facebook", this.data_th.facebook);
      this.data.append("facebook_link", this.data_th.facebook_link);
      this.data.append("line", this.data_th.line);
      this.data.append("line_link", this.data_th.line_link);
      this.data.append("instagram", this.data_th.instagram);
      this.data.append("instagram_link", this.data_th.instagram_link);
      this.data.append("tiktok", this.data_th.tiktok);
      this.data.append("tiktok_link", this.data_th.tiktok_link);
      this.data.append("product_1_pic", this.data_th.product_1_pic);
      this.data.append("product_1_name", this.data_th.product_1_name);
      this.data.append("product_1_price", this.data_th.product_1_price);
      this.data.append(
        "product_1_description",
        this.data_th.product_1_description
      );
      this.data.append("product_2_pic", this.data_th.product_2_pic);
      this.data.append("product_2_name", this.data_th.product_2_name);
      this.data.append("product_2_price", this.data_th.product_2_price);
      this.data.append(
        "product_2_description",
        this.data_th.product_2_description
      );
      this.data.append("product_3_pic", this.data_th.product_3_pic);
      this.data.append("product_3_name", this.data_th.product_3_name);
      this.data.append("product_3_price", this.data_th.product_3_price);
      this.data.append(
        "product_3_description",
        this.data_th.product_3_description
      );
      this.data.append("product_4_pic", this.data_th.product_4_pic);
      this.data.append("product_4_name", this.data_th.product_4_name);
      this.data.append("product_4_price", this.data_th.product_4_price);
      this.data.append(
        "product_4_description",
        this.data_th.product_4_description
      );
      this.data.append("block_list", JSON.stringify(this.data_th.block_list));
      let config = {
        headers: {
          Authorization: `Bearer ${this.$store.state.access_token}`,
        },
      };
      await store_api.updateEng(this.data, config).then((result) => {
        if (result.data.success === true) {
    ...
    async onFileChangeArr(payload, i) {
      ...
      let check = this.pic_list.find((o) => o.id === i);
      if (check == null) {
        this.pic_list.push({ id: i, file: payload });
      }
    },

    async store_pictureOnFileRemoveArr(index) {
        this.loading_page = true;
      this.data_th.pic_list[index] = await {
          ...this.data_th.pic_list[index],
        is_delete: 1
      }
