                        ...
                        <v-row class="m-0 p-4">
                            <v-col cols="12" xs="12" sm="12" md="12" lg="12" xl="12">
                                ...
                                <v-card-text class="p-0">
                                    ...
                                    <v-form ref="form_tennant_add" v-on:submit.prevent="tennantAdd()">
...
export default {
    ...
    methods: {
        ...
        async tennantAdd() {
            if (this.$refs.form_tennant_add.validate()) {
                let config = {
                    headers: {
                ...
                data.append('name', this.tenant_name);
                data.append('personal_id', this.id_card);
                data.append('tax_number', this.tax_id);
                ...
                await tennant.tennantAdd(data, config).then((result) => {
