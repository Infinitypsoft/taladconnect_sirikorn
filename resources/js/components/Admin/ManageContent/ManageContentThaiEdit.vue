                                                ...
                                                <v-form ref="form_content_update" v-on:submit.prevent="contentUpdate()">
                                                    <v-card class="mt-2 p-5 pt-3 hfc" elevation="2">
                                                        ...
                                                        <v-card-text class="p-0 mt-8">
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto"
                                                                    ...
                                                                    v-model="get_data.title_thai" outlined dense single-line
                                                        ...
                                                        <v-card-text class="p-0">
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto"
                                                                    ...
                                                                    v-model="get_data.sub_title_thai" outlined dense
                                                        ...
                                                        <v-card-text class="p-0">
                                                            ...
                                                            <div>
                                                                <vue-editor
                                                                    v-model="get_data.description_thai"></vue-editor>
                                                            </div>
                                                        </v-card-text>
    ...
    methods: {
        ...
        async contentUpdate() {
            if (this.$refs.form_content_update.validate()) {
                ...
                data.append('title_thai', this.get_data.title_thai)
                data.append('sub_title_thai', this.get_data.sub_title_thai)
                data.append('description_thai', this.get_data.description_thai)
