                                                ...
                                                <v-form ref="form_content_add" v-on:submit.prevent="contentAdd()">
                                                    <v-card class="mt-2 p-5 pt-3 hfc" elevation="2">
                                                        ...
                                                        <v-card-text class="p-0 mt-8">
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto" label="กรุณากรอกหัวข้อข่าวสารและกิจกรรม"
                                                                    v-model="title_eng" outlined dense single-line
                                                                    :rules="rules.title_eng" :counter="45"></v-text-field>
                                                            </div>
                                                        </v-card-text>
                                                        <v-card-text class="p-0">
                                                            <div class="d-flex align-center mb-2">
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto" label="กรุณากรอกรายละเอียดโดยย่อ"
                                                                    v-model="sub_title_eng" outlined dense single-line
                                                                    :rules="rules.sub_title_eng"
                                                        ...
                                                        <v-card-text class="p-0">
                                                            ...
                                                            <div>
                                                                <vue-editor v-model="description_eng"></vue-editor>
                                                            </div>
                                                        </v-card-text>
                                                        <v-card-actions>
...
export default {
    ...
    data() {
        return {
            ...
            description_eng: '',
            rules: {
                title_eng: [v => v.length <= 45 || 'สูงสุด 45 ตัวอักษร'],
                sub_title_eng: [v => v.length <= 150 || 'สูงสุด 150 ตัวอักษร']
            },
        }
    },
    methods: {
        ...
        async contentAdd() {
            if (this.$refs.form_content_add.validate()) {
                ...
                data.append('sub_title_eng', this.sub_title_eng)
                ...
                await content.contentAdd(data, config).then((result) => {
                    if (result.data.success === true) {
                        ...
                        this.$router.push(`/managecontent/eng_edit?id=${this.base64Encode(result.data.id)}`)
                    }
                }).catch((error) => {
