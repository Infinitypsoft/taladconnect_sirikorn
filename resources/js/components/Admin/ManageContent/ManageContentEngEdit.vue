                                        ...
                                        <v-card-title class="mt-4 p-0 text-card-title">
                                            <v-row class="container-title">
                                                <v-col xs="12" sm="12" md="5" lg="6" xl="6">
                                                    <p>ข้อมูลข่าวสารและกิจกรรมภาษาอังกฤษ</p>
                                                </v-col>
                                                    ...
                                                    <v-card class="mt-2 p-5 pt-3 hfc" elevation="2">
                                                                    ...
                                                                    <v-card-text class="p-0 mt-2">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <v-file-input class="w-100" outlined dense
                                                                                ...
                                                                                @change="onFileChange" single-line
                                                                                clearable="false" clear-icon=""
                                                        ...
                                                        <v-card-text class="p-0 mt-8">
                                                            <div class="d-flex align-center mb-2">
                                                                <img class="mr-2"
                                                                    :src="base_url + `/images/icon/megaphone 1.png`" alt=" "
                                                                    width="20" height="20" />
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto"
                                                                    label="กรุณากรอกหัวข้อข่าวสารและกิจกรรม"
                                                                    v-model="get_data.title_eng" outlined dense single-line
                                                                    :rules="topicRules" :counter="45"></v-text-field>
                                                            </div>
                                                        </v-card-text>
                                                        <v-card-text class="p-0">
                                                            <div class="d-flex align-center mb-2">
                                                                <img class="mr-2"
                                                                    :src="base_url + `/images/icon/megaphone 2.png`" alt=" "
                                                                    width="20" height="20" />
                                                            ...
                                                            <div>
                                                                <v-text-field hide-details="auto"
                                                                    label="กรุณากรอกรายละเอียดโดยย่อ"
                                                                    v-model="get_data.sub_title_eng" outlined dense
                                                                    single-line :rules="brief_detail_topicRules"
                                                        ...
                                                        <v-card-text class="p-0">
                                                            <div class="d-flex align-center mb-2">
                                                                <img class="mr-2"
                                                                    :src="base_url + `/images/icon/megaphone 3.png`" alt=" "
                                                                    width="20" height="20" />
                                                            ...
                                                            <div>
                                                                <vue-editor v-model="get_data.description_eng"></vue-editor>
                                                            </div>
                                                        </v-card-text>
                                                        <v-card-actions class="justify-center">
                                                            <v-btn type="submit" class="btn-success pl-30 pr-30"
                                                                color="warning" dark>
                                                                <v-icon class="fs-20" large color="white">
                                                                    mdi-content-save
                                                                </v-icon>
...
export default {
    ...
    data() {
        return {
            ...
            get_data: {},
            brief_detail_topic: 'พบกับ 3 เกลอ สจ๊วต เคลวิ่น บ็อบ และแก๊งมินเนี่ยนในรูปแบบ 3 มิติ ทะลุจอ!!',
            brief_detail_topicRules: [v => v.length <= 150 || 'สูงสุด 150 ตัวอักษร'],
        }
    },
    methods: {
        // Get List Content
        ...
        async contentUpdate() {
            if (this.$refs.form_content_update.validate()) {
                ...
                data.append('title_eng', this.get_data.title_eng)
                data.append('sub_title_eng', this.get_data.sub_title_eng)
                data.append('description_eng', this.get_data.description_eng)
