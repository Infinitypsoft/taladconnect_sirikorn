        ...
        <div class="container">
            <div class="d-flex justify-space-between align-items-center mt-4 mb-4">
                <v-card-text class="p-0">
                    <h1 class="font-20 m-0">แก้ไขข้อมูลแผงค้า</h1>
                </v-card-text>
                        ...
                        <v-row class="m-0 p-4">
                            <v-col cols="12" xs="12" sm="12" md="12" lg="12" xl="12">
                                ...
                                <v-card-text class="p-0 mt-2">
                                    ...
                                    <v-form ref="form_stall_add" v-on:submit.prevent="stallUpdate()">
                                        ...
                                        <div class="mt-3">
                                            <v-row class="container-input-contact">
                                                ...
                                                <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="12" xs="12" sm="12" md="3" lg="3" xl="3">
                                                            ...
                                                            <v-text-field  v-model="color_stall" hide-details
                                                        ...
                                                        <v-col cols="12" xs="12" sm="12" md="3" lg="3" xl="3">
                                                            ...
                                                            <v-text-field  v-model="color_table" hide-details="auto"
                                                                class="ma-0 pa-0" solo>
                                                                <template v-slot:append>
                                                ...
                                                <!-- <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                                                    <p class="font-14 text-ex fs-16 fw-500">อัตราค่าเช่ารวมส่วนกลาง
                                                        (เริ่มต้น) <span style="color: red;">*</span></p>
                                                    <v-text-field hide-details="auto" label="กรุณากรอกอัตราค่าเช่ารวมส่วนกลาง (เริ่มต้น)"
                                                        :rules="rules.stall_center_rental_rate"
                                                        v-model="stall_center_rental_rate" outlined dense
                                                        @keypress="validateInput($event, stall_center_rental_rate)"
                                                        single-line></v-text-field>
                                                </v-col>
                                                <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                                                </v-col> -->
                                                ...
                                                <v-col cols="12" xs="12" sm="12" md="6" lg="6" xl="6">
                                                    ...
                                                    <v-text-field hide-details="auto" label="กรุณากรอกอัตราค่าป้ายไวนิล-ป้ายไฟ/ชุด"
                                                        ...
                                                        @keypress="isDecimalInput($event, stall_vinyl_light_set)" outlined
...
export default {
    ...
    methods: {
        ...
        async getStall() {
            ...
            await stall.stallDetail(this.base64Decode(this.$route.query.id), config).then((result) => {
                if (result.data.success === true) {
                    this.data_stall = result.data.data

                    this.imagePreviewURL = this.base_url + `/public/` + this.data_stall.pic_path
                    this.content_picture = { name: this.data_stall.pic }

                    this.color_stall = this.data_stall.color_stall

                    this.color_table = this.data_stall.color_table
                    this.stall_select_type = this.data_stall.type

                    this.stall_name = this.data_stall.name
                    this.stall_size_w = this.data_stall.size_w
                    this.stall_size_h = this.data_stall.size_h
                    this.stall_annual_fee = this.data_stall.annual_fee
                    this.stall_radio_annual_fee = this.data_stall.radio_annual_fee
                    this.stall_service_rate = this.data_stall.guarantee_service_rate
                    this.stall_water_rate = this.data_stall.guarantee_water_rate
                    this.stall_electricity_rate = this.data_stall.guarantee_electricity_rate
                    this.stall_hood_rate = this.data_stall.guarantee_hood_rate
                    // this.stall_center_rental_rate = `${this.data_stall.cost_center_rental_rate_min} - ${this.data_stall.cost_center_rental_rate_max}`
                    this.stall_rental_rate = this.data_stall.cost_rental_rate
                    this.stall_common_rate = this.data_stall.cost_common_rate
                    this.stall_water_unit_rate = this.data_stall.cost_water_unit_rate
                    this.stall_electricity_unit_rate = this.data_stall.cost_electricity_unit_rate
                    this.stall_vinyl_light_set = `${this.data_stall.vinyl_light_set_min} - ${this.data_stall.vinyl_light_set_max}`
                    this.stall_water_sync_rate = this.data_stall.water_sync_rate
                    this.stall_grease_tank_rate = this.data_stall.grease_tank_rate
        ...
        async stallUpdate() {
            if (this.$refs.form_stall_add.validate()) {
                ...
                // const stall_center_rental_rate_input = this.stall_center_rental_rate.replace(/\s/g, "");
                ...
                data.append('id', this.data_stall.id)
                ...
                data.append('annual_fee', this.stall_annual_fee);
                ...
                await stall.stallUpdate(data, config).then((result) => {
                    if (result.data.success === true) {
                        this.loading_page = false;
